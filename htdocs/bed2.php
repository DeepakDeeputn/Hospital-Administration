...
<div class="tt"><h2>HOME</h2></div></a>
   ...
   <h2> 3. Low Beds<br></h2>
    There used for patients who are at risk of falling. Low beds are also commonly used for children
     and Alzheimers patients.<br>
   <h2> 4. Air Loss Mattresses<br></h2>
   ...
   <h2> 5. Circo-Electric Beds<br></h2>
    These beds are required for patients that have serious burns, skin conditions, or spinal injuries. <br>
   <h2> 6. Clinitron Beds<br></h2>
    These beds reduce pressure on the patients skin since due to its filling that is similar to sand.
     Moisture is kept out and warm air isdistributed throughout the mattress to maintain temperature levels
      and support the patients weight.<br>
    <h2>7. Air Fluidized Beds<br></h2> 
